...
>>> 
>>> values = {}
>>> values['username'] = "1131947102@qq.com"
>>> values['password'] = "Zhao6Jin8Heng"
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=3B30B402595E67CAD426C03C1FA570FC.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=3B30B402595E67CAD426C03C1FA570FC.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=3B30B402595E67CAD426C03C1FA570FC.tomcat1" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=3B30B402595E67CAD426C03C1FA570FC.tomcat1?from=http://my.csdn.net/my/mycsdn" method="post">
					...
					<input type="hidden" name="lt" value="LT-309570-fdJ9yz13eCBcyc0aL5tboWUdHnacPR" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=3B30B402595E67CAD426C03C1FA570FC.tomcat1"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=3B30B402595E67CAD426C03C1FA570FC.tomcat1" src="/js/libs/require.js;jsessionid=3B30B402595E67CAD426C03C1FA570FC.tomcat1"></script>
    <script type="text/javascript">
